...
import cv2  # New import for drawing
...
def generate_samples(yaml_path: str, output_dir: str, num_samples: int):
    ...
    # --- 2. Index Images by Class (from ALL splits) ---
    ...
    output_viz_path = output_path / "visualized_images"  # New directory
    ...
    # --- 5. Copy Files and Draw Bounding Boxes ---
